...
A directory `G&CD_Dir` is created if it does not already exist and the data is downloaded in it. `unzip` function is used to unzip the files in the same directory. x_test, x_train, y_test, y_train, subject_test, subject_train and features files are loaded from their respective folders using the `read.table` function. `echo = FALSE`
